...
export default function AdministrationDetail({ 
    ...
    const handleApprove = async () => {
        ...
        try {
            // Simulate API call
            setTimeout(() => {
                router.post(`/dashboard/administration/${user.id}/approve`, {}, {
                    onSuccess: () => {
                        // Redirect ke halaman assessment atau tampilkan success message
                        router.visit('/dashboard/assessment');
                    },
                    onError: (errors) => {
    ...
    const handleReject = async () => {
        ...
        try {
            ...
            setTimeout(() => {
                router.post(`/dashboard/administration/${user.id}/reject`, {}, {
                    onSuccess: () => {
                        router.visit('/dashboard/administration');
                    },
                    onError: (errors) => {
                ...
                <div className="flex items-center justify-between">
                    <div className="flex items-center gap-4">
                        <Button
                            variant="outline"
                            size="icon"
                            onClick={() => router.visit('/dashboard/administration')}
                        >
