...
import { EyeIcon, Pencil, Trash2, ChevronLeft, ChevronRight } from 'lucide-react';
            ...
            <Table className="table-fixed">
                <TableHeader>
                    <TableRow>
                        ...
                        <TableHead className="w-[15%] text-right pr-10">Actions</TableHead>
                    </TableRow>
                </TableHeader>
                <TableBody>
                    {isLoading ? (
                        // Skeleton loading rows
                        Array(pagination.per_page).fill(0).map((_, idx) => (
                            <TableRow key={`skeleton-${idx}`}>
                                <TableCell className="w-[8%]"><Skeleton className="h-4 w-8" /></TableCell>
                                <TableCell className="w-[20%]"><Skeleton className="h-4 w-full" /></TableCell>
                                <TableCell className="w-[22%]"><Skeleton className="h-4 w-full" /></TableCell>
                                <TableCell className="w-[10%]"><Skeleton className="h-6 w-16 rounded-full" /></TableCell>
                                <TableCell className="w-[10%]"><Skeleton className="h-6 w-16 rounded-full" /></TableCell>
                                <TableCell className="w-[15%]"><Skeleton className="h-4 w-24" /></TableCell>
