...
import { AlertTriangle, Building2, Edit, Eye, Filter, Mail, MapPin, Phone, Plus, Search, Trash2 } from 'lucide-react';
...
export default function CompaniesIndex({ companies }: Props) {
    ...
    const handleViewPeriods = (company: Company) => {
        router.visit(route('companies.periods', company.id));
    };
                        ...
                        <DialogContent>
                            ...
                            <div className="py-4">
                                <ul className="list-disc list-inside space-y-1 text-sm text-gray-600">
                                    <li>All recruitment periods</li>
                                    <li>Associated job positions</li>
                                    <li>Application data</li>
                                    <li>Company settings and configurations</li>
                                </ul>
                            </div>
                    ...
                    <Card>
                        <CardHeader className="flex flex-col items-start justify-between gap-4 md:flex-row md:items-center">
                            <div>
                                ...
                                <CardDescription>Manage your companies and their recruitment periods</CardDescription>
                            </div>
